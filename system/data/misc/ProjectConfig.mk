...
CUSTOM_KERNEL_LCM = nt36760_dsi_vdo_sgmicro_sgm3804 r69006_dsi_cmd_truly_sgm3804 nt35596_hd1080_vdo_sharp_tps65132 boe_nt36760_dsi_cmd_sgm3804 boe_nt35596s_dsi_vdo_lp3101
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = bu6429af lc898217af dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = mxg2320-new
...
CUSTOM_KERNEL_TOUCHPANEL = synaptics_3320_61 atmel_mxt
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = nt36760_dsi_vdo_sgmicro_sgm3804 r69006_dsi_cmd_truly_sgm3804 nt35596_hd1080_vdo_sharp_tps65132 boe_nt36760_dsi_cmd_sgm3804 boe_nt35596s_dsi_vdo_lp3101
ifeq ($(TARGET_CARRIER), hongkong)
CUSTOM_MODEM = mt6795_sp_lwg_dsds
else ifeq ($(TARGET_CARRIER), india)
CUSTOM_MODEM = mt6795_sp_lwg_dsds
else ifeq ($(TARGET_CARRIER), thailand)
CUSTOM_MODEM = mt6795_sp_lwg_dsds
else
CUSTOM_MODEM = mt6795_sp_lwg_dsds mt6795_sp_lttg_dsds
endif
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = nt36760_dsi_vdo_sgmicro_sgm3804 r69006_dsi_cmd_truly_sgm3804 nt35596_hd1080_vdo_sharp_tps65132 boe_nt36760_dsi_cmd_sgm3804 boe_nt35596s_dsi_vdo_lp3101
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = ALPS.L0.MP6.V1.2_CCI6795.LWT.CU_P303
MTK_BWC_SUPPORT = yes
...
#CREATE_PROJECT_INFO=20150109193646
EXTCODEC_ECHO_REFERENCE_SUPPORT = yes
...
# Add LETV meida compile options to wrap LETV's modifications on AOSP.
LETV_AOSP_MEDIA_ENHANCEMENT=yes

ifeq ($(TARGET_CARRIER), cu_without_features)
...
ifeq ($(TARGET_CARRIER), cmcc_without_features)
    OPTR_SPEC_SEG_DEF = OP01_SPEC0200_SEGA
endif

ifeq ($(TARGET_CARRIER), cmcc)
    OPTR_SPEC_SEG_DEF = OP01_SPEC0200_SEGA
endif
